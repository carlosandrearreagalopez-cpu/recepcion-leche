...
/* Ocultar el texto duplicado interno y dejar limpia la zona de carga */
...
/* Caja de carga de archivos (file_uploader) limpia y completamente interactiva */
...
# ==========================================================
    ...
    if st.session_state["enviado_exitoso"]:
        ...
        with st.form("form_recepcion_leche"):
            ...
            st.caption("Parámetro esperado: Menor o igual a 7°C.")
    ...
    if os.path.exists(EXCEL_FILE):
        ...
        with tab_tabla:
            ...
            if indices_disponibles:
                ...
                if st.button("❌ Eliminar este registro definitivamente"):
            ...
            for idx, row in df_filtrado.iterrows():
                with st.container():
                    ...
                    if st.button(f"Ver detalle completo #{idx}", key=f"btn_ver_{idx}"):
                        ...
                        st.markdown("---")
                        st.markdown("#### Evidencias y Firmas Registradas")
